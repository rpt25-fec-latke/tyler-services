  ...
  while (startingGameId <= numGames) {
    ...
    while (numReviews > 0) {
      ...
      const data = {
        ...
        warmBlanketAwardCount: Math.round(Math.random() * 1),
        saucyAwardCount: Math.round(Math.random() * 1),
        slowClapAwardCount: Math.floor(Math.random() * 2),
        takeMyPointsAwardCount: Math.round(Math.random() * 1),
        wholesomeAwardCount: Math.round(Math.random() * 1) > 0.5 ? Math.floor(Math.random() * 6) : 0,
        jesterAwardCount: Math.round(Math.random() * 1),
        fancyPantsAwardCount: Math.floor(Math.random() * 3),
        whoaAwardCount: Math.round(Math.random() * 1),
        superStarAwardCount: Math.round(Math.random() * 1),
        wildAwardCount: Math.round(Math.random() * 1) > 0.5 ? Math.floor(Math.random() * 6) : 0,
        treasureAwardCount: Math.floor(Math.random() * 2),
        mindBlownAwardCount: Math.floor(Math.random() * 1),
        goldenUnicornAwardCount: Math.round(Math.random() * 1),
        deepThoughtsAwardCount: Math.round(Math.random() * 1),
        heartWarmingAwardCount: Math.floor(Math.random() * 3),
        hilariousAwardCount: Math.round(Math.random() * 1) > 0.5 ? Math.floor(Math.random() * 6) : 0,
        hotTakeAwardCount: Math.round(Math.random() * 1),
        poetryAwardCount: Math.round(Math.random() * 1) > 0.5 ? Math.floor(Math.random() * 6) : 0,
        extraHelpfulAwardCount: Math.floor(Math.random() * 2),
        gottaHaveItAwardCount: Math.round(Math.random() * 1),
        michelangeloAwardCount: Math.round(Math.random() * 1),
        madScinetistAwardCount: Math.floor(Math.random() * 2),
